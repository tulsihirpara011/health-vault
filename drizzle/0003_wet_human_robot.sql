ALTER TABLE "documents" ALTER COLUMN "file_name" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "documents" ALTER COLUMN "structured_extracted_data" SET DATA TYPE json;--> statement-breakpoint
